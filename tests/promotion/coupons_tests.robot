...
Create Product And Coupon Then Apply Coupon During Checkout Successfully
    ...
    Fill Required Product Information    ${product_name}    ${sku}    ${price}    ${url_key}
    Save Product
