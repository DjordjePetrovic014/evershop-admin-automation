...
Create a New Category Successfully
    ...
    Login As Admin    ${VALID_EMAIL}    ${VALID_PASSWORD}
    ${category}=    Generate Unique Category Data
    Create Category
    ...    ${category.name}
    ...    ${category.url_key}
    ...    ${category.meta_title}
    ...    ${category.meta_description}
    Category Should Appear In Categories List    ${category.name}
...
Create And Delete Category Successfully
    ...
    Category Should Not Appear In Categories List    ${category.name}
